...
INSERT INTO flights VALUES
    ...
    ('El Dabaa','Al Alamain International Airport','DBB'),
    ...
    ('Libreville','Libreville International Airport','LBV'),
    ...
    ('Tangier','Tangier-Boukhalef Airport','TNG'),
    ...
    ('Marsh Harbour','Marsh Harbour International Airport','MHH[1]'),
    ...
    ('Santa Clara','Abel Santa María Airport','SNU'),
    ...
    ('Roseau','Melville Hall Airport','DOM'),
    ...
    ('Pointe-à-Pitre','Pôle Caraïbes International Airport','PTP'),
    ...
    ('St. Jean','Gustaf III Airport','SBH'),
    ('Saint Kitts','Robert L. Bradshaw International Airport','SKB'),
    ...
    ('Tobago','Arthur Napoleon Raymond Robinson International Airport (formerly Crown Point International Airport)','TAB'),
    ('Providenciales','Providenciales Airport','PLS'),
    ('Saint Thomas','Cyril E. King Airport','STT'),
    ('Saint Croix','Henry E. Rohlsen Airport','STX'),
    ('Belize City','Philip S. W. Goldson International Airport','BZE'),
    ('Liberia','Daniel Oduber Quirós International Airport','LIR'),
    ('San José de Costa Rica','Juan Santamaría International Airport','SJO'),
    ...
    ('St. George''s, Bermuda','L.F. Wade International Airport','BDA'),
    ...
    ('Halifax (Goffs)','Halifax Stanfield International Airport','YHZ'),
    ('Hamilton','John C. Munro Hamilton International Airport','YHM'),
    ('Kelowna','Kelowna International Airport','YLK'),
    ('London','London International Airport','YXU'),
    ('Moncton (Dieppe)','Greater Moncton International Airport','YQM'),
    ('Montreal (Dorval)','Montreal-Pierre Elliott Trudeau International Airport','YUL'),
    ('Ottawa','Ottawa Macdonald-Cartier International Airport','YOW'),
    ('Quebec City','Quebec/Jean Lesage International Airport','YQB'),
    ...
    ('Mississauga / Toronto','Toronto Pearson International Airport','YYZ'),
    ('Vancouver (Richmond)','Vancouver International Airport','YVR'),
    ...
    ('Aguascalientes','Lic. Jesús Terán Peredo International Airport','AGU'),
    ('Cancún','Cancun International Airport','CUN'),
    ('Chihuahua','Roberto Fierro Villalobos International Airport','CUU'),
    ('Ciudad del Carmen','Ciudad del Carmen International Airport','CME'),
    ('Cozumel','Cozumel International Airport','CZM'),
    ('Culiacán','Federal de Bachigualato International Airport','CUL'),
    ...
    ('Ixtapa','Ixtapa-Zihuatanejo International Airport','ZIH'),
    ...
    ('Mazatlán','General Rafael Buelna International Airport','MZT'),
    ('Mérida','Manuel Crescencio Rejón International Airport','MID'),
    ...
    ('Puerto Vallarta','Lic. Gustavo Díaz Ordaz International Airport','PVR'),
    ...
    ('San Luis Potosí','Ponciano Arriaga International Airport','SLP'),
    ('Tampico','General Francisco Javier Mina International Airport','TAM'),
    ('Tijuana','Gral. Abelardo L. Rodríguez International Airport','TIJ'),
    ('Toluca','Lic. Adolfo López Mateos International Airport','TLC'),
    ('Torreón','Francisco Sarabia International Airport','TRC'),
    ('Tuxtla Gutierrez','Angel Albino Corzo International Airport','TGZ'),
    ('Uruapan','Uruapan International Airport','UPN'),
    ...
    ('Akron','Akron Executive Airport','AKC'),
    ...
    ('Dayton (OH)','Dayton International Airport','DAY'),
    ...
    ('Green Bay','Green Bay–Austin Straubel International Airport','GRB'),
    ...
    ('Melbourne (FL)','Melbourne International Airport','MLB'),
    ('Memphis','Memphis International Airport','MEM'),
    ('Miami','Miami International Airport','MIA'),
    ('Midland','Midland International Air & Space Port','MAF'),
    ...
    ('Phoenix/Mesa','Phoenix–Mesa Gateway Airport','AZA'),
    ...
    ('Racine','Batten International Airport','RAC'),
    ...
    ('Rochester (NY)','Greater Rochester International Airport','ROC'),
    ...
    ('Ushuaia','Ushuaia International Airport','USH'),
    ...
    ('Santiago de Chile','Comodoro Arturo Merino Benítez International Airport','SCL'),
    ...
    ('Shymkent','Shymkent Airport','CIT'),
    ('Taraz','Taraz Airport','DMB'),
    ('Bishkek','Manas Airport','FRU'),
    ('Issyk-Kul','Issyk-Kul International Airport','IKU'),
    ('Karakol','Karakol International Airport','КПЖ(Russian)'),
    ('Osh','Osh Airport','OSS'),
    ...
    ('Kitakyushu','New Kitakyushu Airport','KKJ'),
    ...
    ('Tokyo/Yokohama','Haneda International Airport','HND'),
    ('Tokyo/Chiba','Narita International Airport','NRT'),
    ...
    ('Guiyang','Guiyang Longdongbao Airport','KWE'),
    ...
    ('Hohhot','Hohhot Airport','HET'),
    ('Huai''an','Huai''an Lianshui Airport','HIA'),
    ...
    ('Manzhouli','Manzhouli Airport','NZH'),
    ('Meizhou','Meixian Airport','MXZ'),
    ('Mudanjiang','Mudanjiang Airport','MDG'),
    ...
    ('Ordos City','Ordos Ejin Horo Airport','DSN'),
    ...
    ('Xining','Xining Caojiabao Airport','XNN'),
    ...
    ('Taoyuan','Taoyuan International Airport','TPE'),
    ...
    ('Gaya','Gaya International Airport','GAY'),
    ...
    ('Hulhule Island','Velana International Airport','MLE'),
    ...
    ('Banyuwangi','Banyuwangi International Airport','BWX'),
    ('Batam','Hang Nadim International Airport','BTH'),
    ('Biak','Frans Kaisiepo International Airport','BIK'),
    ...
    ('Mataram','Zainuddin Abdul Madjid International Airport','LOP'),
    ...
    ('Pekanbaru','Sultan Syarif Qasim II International Airport','PKU'),
    ('Pontianak','Supadio International Airport','PNK'),
    ('Semarang','Ahmad Yani International Airport','SRG'),
    ('Siborong-Borong','Sisingamangaraja XII International Airport','DTB'),
    ('Surabaya','Juanda International Airport','SUB'),
    ('Surakarta','Adisumarmo International Airport','SOC'),
    ('Tanjung Pandan','H.A.S. Hanandjoeddin International Airport','TJQ'),
    ...
    ('Kuala Lumpur/Sepang','Kuala Lumpur International Airport','KUL'),
    ...
    ('Subang','Sultan Abdul Aziz Shah Airport','SZB'),
    ('Mandalay','Mandalay International Airport','MDL'),
    ('Yangon','Yangon International Airport','RGN'),
    ('Naypyidaw','Naypyidaw International Airport','NYT'),
    ('Basco','Basco Airport','BSO'),
    ('Cagayan Special Economic Zone','Cagayan North International Airport','LLC'),
    ('Lapu-Lapu','Mactan–Cebu International Airport','CEB'),
    ...
    ('Bangkok/Samut Prakan','Suvarnabhumi Airport','BKK'),
    ...
    ('Quảng Nam','Chu Lai International Airport','VCL'),
    ...
    ('Mazar-i-Sharif','Mazar-e Sharif International Airport','MZR'),
    ...
    ('Al-Jawf','Al-Jawf Airport','AJF'),
    ('Buraydah','Prince Nayef bin Abdulaziz International Airport','ELQ'),
    ...
    ('Freiburg im Breisgau','EuroAirport Basel–Mulhouse–Freiburg','MLH/BSL/EAP'),
    ...
    ('Santorini','Santorini (Thira) National Airport','JTR'),
    ...
    ('Valletta','Malta International Airport','MLA'),
    ...
    ('Doncaster/Sheffield','Robin Hood Airport Doncaster Sheffield','DSA'),
    ('Middlesbrough','Durham Tees Valley Airport','MME'),
    ('Nottingham/Leicester','East Midlands Airport','EMA'),
    ('Exeter','Exeter International Airport','EXT'),
    ('Leeds/Bradford','Leeds Bradford International Airport','LBA'),
    ...
    ('Yaren','Nauru International Airport','INU'),
    ...
    ('Dunedin','Dunedin International Airport','DUD'),
    ('Queenstown','Queenstown Airport','ZQN'),
    ('Wellington','Wellington International Airport','WLG'),
    ('Norfolk Island','Norfolk Island Airport','NLK'),
    ('Rota Island','Rota International Airport','ROP'),
    ('Saipan Island','Saipan International Airport','SPN'),
    ...
    ('Vavaʻu','Vava''u International Airport','VAV'),
...
INSERT INTO bookings VALUES
		(1,'5VJ51','Indigo','DEL','IAD','01/27/2021','20:00',12060.82),
        (2,'6EH82','Jet AirWay','DEL','IAD','01/27/2021','18:00',12060.82),
        (3,'5JW29','SpiceJet','CCU','IAD','10/29/2021','07:30',13012.55);
