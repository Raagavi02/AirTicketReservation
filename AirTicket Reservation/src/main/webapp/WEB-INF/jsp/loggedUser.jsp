...
<body>
	<div class="topnav">
		...
		<div class="top">
			<a href="#news" onclick="myfunction0()">Home</a> <a href="/contact?username=${login.username}"
				onclick="myfunction1()">Contact</a>  <a href="/logout">Logout</a>
		</div>
	</div>
	<div id="mySidepanel" class="sidepanel">
		<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">
			X</a>
		<h1 style="margin: 0; color: #F0F0F0;">Hello!<br> <h4 style="color:#F0F0F0;">${login.username}</h4></h1>
		<br><br>
		<a href="#" onclick="contain()">Change Password</a>
		<form id="form1" action="/mybooking?username=${login.username}"
			method="post">
			<a href="javascript:;"
				onclick="document.getElementById('form1').submit();">My Bookings</a>
		</form>
		<a href="/homeagain?username=${login.username}">Book Ticket</a> <a href="/logout">Logout</a>
	</div>
