...
<body>
<h1 style="text-align:center;padding:60px;">User Login</h1>
...
<table>
	...
	<tr>
		<td><input id="refer" class="btn btn-success" type="submit" value="Login"></td>
		<td><a href="#" class="btn btn-success" id="container">SignUp </a></td>
	</tr>
</table><br>
...
<div class="popup">
	<div class="popup-container">
		...
		<h4>Email</h4><br>
		<form onsubmit="my()" action="/checkingmail" method="post" >	
...
<div class="popupagain">
	<div class="popup-container">
		...
		<form onsubmit="my()" action="/forgot" method="post">	
			...
			<input type="submit" class="btn btn-success" value="continue" required="required">
		</form>
	</div>
</div>	
